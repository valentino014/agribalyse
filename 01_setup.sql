...
CREATE SCHEMA IF NOT EXISTS DATABASE_AGRIBALYSE.CI;
CREATE SCHEMA IF NOT EXISTS DATABASE_AGRIBALYSE.CI_STAGING;
CREATE SCHEMA IF NOT EXISTS DATABASE_AGRIBALYSE.CI_INTERMEDIATE;
CREATE SCHEMA IF NOT EXISTS DATABASE_AGRIBALYSE.CI_MARTS;
...
CREATE RESOURCE MONITOR IF NOT EXISTS RM_AGRIBALYSE WITH
  CREDIT_QUOTA = 10
  FREQUENCY = MONTHLY
...
GRANT USAGE, CREATE TABLE, CREATE VIEW ON SCHEMA DATABASE_AGRIBALYSE.CI TO ROLE TRANSFORMAGRIBALYSE;
GRANT USAGE, CREATE TABLE, CREATE VIEW, CREATE STAGE, CREATE FILE FORMAT ON SCHEMA DATABASE_AGRIBALYSE.CI_STAGING TO ROLE TRANSFORMAGRIBALYSE;
GRANT USAGE, CREATE TABLE, CREATE VIEW ON SCHEMA DATABASE_AGRIBALYSE.CI_INTERMEDIATE TO ROLE TRANSFORMAGRIBALYSE;
GRANT USAGE, CREATE TABLE, CREATE VIEW ON SCHEMA DATABASE_AGRIBALYSE.CI_MARTS        TO ROLE TRANSFORMAGRIBALYSE;
